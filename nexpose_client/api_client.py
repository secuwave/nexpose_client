...
from nexpose_client.configuration import Configuration
import nexpose_client.models
from nexpose_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(nexpose_client.models, klass)
