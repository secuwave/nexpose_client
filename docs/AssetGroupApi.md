...
api_instance = nexpose_client.AssetGroupApi()
...
# create an instance of the API class
api_instance = nexpose_client.AssetGroupApi()
param0 = nexpose_client.AssetGroup() # AssetGroup | The details of the asset group. (optional)
...
api_instance = nexpose_client.AssetGroupApi()
id = 56 # int | The identifier of the asset group.
param1 = nexpose_client.SearchCriteria() # SearchCriteria | The search criteria specification. (optional)
...
api_instance = nexpose_client.AssetGroupApi()
id = 56 # int | The identifier of the asset group.
param1 = [nexpose_client.list[int]()] # list[int] | The tags to associate to the asset group. (optional)
...
api_instance = nexpose_client.AssetGroupApi()
id = 56 # int | The identifier of the asset group.
param1 = [nexpose_client.list[int]()] # list[int] | The users to grant access to the asset group. (optional)
...
api_instance = nexpose_client.AssetGroupApi()
id = 56 # int | The identifier of the asset group.
param1 = nexpose_client.AssetGroup() # AssetGroup | The details of the asset group. (optional)
...
api_instance = nexpose_client.AssetGroupApi()
id = 56 # int | The identifier of the asset group.
param1 = [nexpose_client.list[int]()] # list[int] | The assets to place in the asset group.  (optional)
