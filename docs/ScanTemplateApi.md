# nexpose_client.ScanTemplateApi
...
api_instance = nexpose_client.ScanTemplateApi()
param0 = nexpose_client.ScanTemplate() # ScanTemplate | The details of the scan template. (optional)
...
api_instance = nexpose_client.ScanTemplateApi()
id = 'id_example' # str | The identifier of the scan template
param1 = nexpose_client.ScanTemplate() # ScanTemplate | The details of the scan template. (optional)
