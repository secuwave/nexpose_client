# nexpose_client.PolicyOverrideApi
...
api_instance = nexpose_client.PolicyOverrideApi()
param0 = nexpose_client.PolicyOverride() # PolicyOverride | The specification of a policy override. Allows users to override the compliance result of a policy rule. (optional)
