...
api_instance = nexpose_client.CredentialApi()
param0 = nexpose_client.SharedCredential() # SharedCredential | The specification of a shared credential. (optional)
...
api_instance = nexpose_client.CredentialApi()
id = 56 # int | The identifier of the credential.
param1 = nexpose_client.SharedCredential() # SharedCredential | The specification of the shared credential to update. (optional)
