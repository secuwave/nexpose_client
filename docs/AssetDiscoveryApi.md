# nexpose_client.AssetDiscoveryApi
...
api_instance = nexpose_client.AssetDiscoveryApi()
param0 = nexpose_client.SonarQuery() # SonarQuery | param0
...
# create an instance of the API class
api_instance = nexpose_client.AssetDiscoveryApi()
param0 = nexpose_client.SonarCriteria() # SonarCriteria | param0
...
api_instance = nexpose_client.AssetDiscoveryApi()
id = 789 # int | The identifier of the Sonar query.
param1 = nexpose_client.SonarQuery() # SonarQuery | param1
