...
api_instance = nexpose_client.ScanEngineApi()
...
# create an instance of the API class
api_instance = nexpose_client.ScanEngineApi()
param0 = nexpose_client.ScanEngine() # ScanEngine | The specification of a scan engine. (optional)
...
# create an instance of the API class
api_instance = nexpose_client.ScanEngineApi()
param0 = nexpose_client.EnginePool() # EnginePool | The details for the scan engine to update. (optional)
...
api_instance = nexpose_client.ScanEngineApi()
id = 56 # int | The identifier of the engine pool.
param1 = [nexpose_client.list[int]()] # list[int] | The identifiers of the scan engines to place into the engine pool. (optional)
...
api_instance = nexpose_client.ScanEngineApi()
id = 56 # int | The identifier of the scan engine.
param1 = nexpose_client.ScanEngine() # ScanEngine | The specification of the scan engine to update. (optional)
...
api_instance = nexpose_client.ScanEngineApi()
id = 56 # int | The identifier of the engine pool.
param1 = nexpose_client.EnginePool() # EnginePool | The details for the scan engine to update. (optional)
