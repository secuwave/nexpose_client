...
api_instance = nexpose_client.UserApi()
...
# create an instance of the API class
api_instance = nexpose_client.UserApi()
param0 = nexpose_client.User() # User | The details of the user. (optional)
...
api_instance = nexpose_client.UserApi()
id = 56 # int | The identifier of the user.
param1 = [nexpose_client.list[int]()] # list[int] | The identifiers of the asset groups to grant the user access to. Ignored if user has access to `allAssetGroups`. (optional)
...
api_instance = nexpose_client.UserApi()
id = 56 # int | The identifier of the user.
param1 = [nexpose_client.list[int]()] # list[int] | The identifiers of the sites to grant the user access to. Ignored if the user has access to `allSites`. (optional)
...
api_instance = nexpose_client.UserApi()
id = 'id_example' # str | The identifier of the role.
param0 = nexpose_client.Role() # Role | The details of the role. (optional)
...
api_instance = nexpose_client.UserApi()
id = 56 # int | The identifier of the user.
param1 = nexpose_client.User() # User | The details of the user. (optional)
