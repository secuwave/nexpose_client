...
api_instance = nexpose_client.TagApi()
param0 = nexpose_client.Tag() # Tag | The details of the tag. (optional)
...
api_instance = nexpose_client.TagApi()
id = 56 # int | The identifier of the tag.
param1 = [nexpose_client.list[int]()] # list[int] | The asset groups to add to the tag. (optional)
...
api_instance = nexpose_client.TagApi()
id = 56 # int | The identifier of the tag.
param1 = [nexpose_client.list[int]()] # list[int] | The sites to add to the tag. (optional)
...
api_instance = nexpose_client.TagApi()
id = 56 # int | The identifier of the tag.
param1 = nexpose_client.SearchCriteria() # SearchCriteria | The details of the search criteria. (optional)
